...
public class SimpleSearchDTO {
    ...
    private static String PARAM_SEARCH_PREFIX = "search_";
        private String search_table2_no;     //表编号2

        public void setSearch_table2_no(String table2_no){
            this.search_table2_no = table2_no;
        }
        public String getSearch_table2_no(){
            return this.search_table2_no;
        }

        private String search_table1_no;     //表编号1
        ...
        private String search_table2_name;     //属性名

        public void setSearch_table2_name(String table2_name){
            this.search_table2_name = table2_name;
        }
        public String getSearch_table2_name(){
        ...
        public void setSearch_table2_no(String fk){
            this.search_table2_no = fk;
        }
        public String getSearch_table2_no(){
            return this.search_table2_no;
        }
